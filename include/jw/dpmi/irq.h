...
namespace jw
{
    namespace dpmi
    {
        ...
        enum irq_config_flags
        {
            ...
            // This option effectively implies no_reentry. Note that the default handler will always enable interrupts, which makes the no_interrupts option less effective.
            always_chain = 0b10,
